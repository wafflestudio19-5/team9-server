...
class PostCreateSwaggerSerializer(serializers.Serializer):
    ...
    tagged_users = serializers.ListField(
        child=serializers.IntegerField(), required=False, help_text="태그된 유저들의 id의 array"
    )
    subposts_tagged_users = serializers.ListField(
        required=False, help_text="subpost별로 태그된 유저들의 id의 array들의 array (nested array)"
    )
...
class PostUpdateSwaggerSerializer(PostCreateSwaggerSerializer):
    subposts = serializers.ListField(
        ...
        required=False,
        help_text="subpost들의 content의 array",
    )
    subposts_id = serializers.ListField(
        child=serializers.IntegerField(),
        required=False,
        help_text="기존 subpost들의 id의 array",
    )
    removed_subposts = serializers.ListField(
        child=serializers.IntegerField(),
        required=False,
        help_text="삭제될 subpost들의 id의 array",
    )
